...
import database.handles.create_tables as create_tables
...
def connect(isShowConnect = False):
    try:
        CONNECTION = mysql.connector.connect(host=HOST, database=DATABASE, user=USER, password=PASSWORD)
        if isShowConnect == True:
